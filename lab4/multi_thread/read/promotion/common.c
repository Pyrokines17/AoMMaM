...
double char_read(void* buf, size_t size_in_bytes) {
...
void* thread_func(void* args) {
    ...
    switch (data_type) { 
        ...
        case CHAR: {
            gbps = char_read(buf, size_in_bytes);
            break;
        }
    }
...
int main(int argc, char* argv[]) {
    ...
    switch (in_data_type) { 
        ...
        case CHAR: {
            gbps = char_read(buf, size_in_bytes_per_thread);
            break;
        }
    }
